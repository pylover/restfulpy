...
class ValidationBlackListTestCase(WebAppTestCase):
    ...
    def test_validation_blacklist(self):
        ...
        self.request('All', 'POST', '/validation', params={'blacklistParamForAll': 'param'},
                     expected_status=400)
        self.request('All', 'POST', '/validation', params={'blacklistParamForClient': 'param'})
        self.request('All', 'POST', '/validation', params={'blacklistParamForAdmin': 'param'})
        # -----------------------------
        # role -> Client
        self.wsgi_application.jwt_token = DummyIdentity('client').dump().decode()
        self.request('Client', 'POST', '/validation')
        self.request('Client', 'POST', '/validation', params={'customParam': 'param'})
        self.request('Client', 'POST', '/validation', params={'blacklistParamForAll': 'param'},
                     expected_status=400)
        self.request(
        ...
        self.request('Client', 'POST', '/validation', params={
        ...
        self.request('Admin', 'POST', '/validation', params={'customParam': 'param'})
        self.request('Admin', 'POST', '/validation', params={'blacklistParamForAll': 'param'},
                     expected_status=400)
        self.request('Admin', 'POST', '/validation', params={'blacklistParamForClient': 'param'})
        self.request('Admin', 'POST', '/validation', params={'blacklistParamForAdmin': 'param'},
                     expected_status=400)
